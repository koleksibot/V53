...
try {
        ...
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© _*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		pporang = 'https://i.imgur.com/ZVZbhRg.jpeg'
		      }
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "𝑳𝑶𝑹𝑫⇥𝑺𝑬𝑹⁩", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'😱SHOW MENU'},type:1},
{buttonId:`owner`,buttonText:{displayText:'😎OWNER'},type:1},
{buttonId:`script`,buttonText:{displayText:'📃SCRIPT'},type:1}
...
╭─❒ 𝙱𝙾𝚃 𝙱𝚈 *𝑳𝑶𝑹𝑫⇥𝑺𝑬𝑹⁩*
├𖣘 𝚂𝚌𝚛𝚒𝚙𝚝 𝚌𝚑𝚘𝚍𝚒𝚌𝚑𝚞 𝚙𝚖 𝚟𝚊𝚛𝚊𝚗𝚍𝚊🐦
├𖣘 𝙿𝚁𝙸𝚅𝙰𝚃𝙴 𝙱𝙾𝚃 𝙰𝙽𝙽 𝙼𝚆𝙽𝙾𝙴
├𖣘 𝙷𝙴𝙻𝙿𝙴𝙳 𝙱𝚈 𝚂𝙿𝚈𝚁𝙾 𝚂𝙴𝚁 ❣️
├𖣘 𝙲𝚁𝙴𝙰𝚃𝙾𝚁 : *𝑳𝑶𝑹𝑫 ⇥𝑺𝑬𝑹ꫂ⁩*
├𖣘 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙼𝙴 : wa.me/919778383987
...
├⸙ *𝑳𝑶𝑹𝑫⇥𝑺𝑬𝑹⁩*
└─────────────────❒`
sendButLocation(from, `${menu}`, "𝑳𝑶𝑹𝑫⇥𝑺𝑬𝑹", {jpegThumbnail:gambar,name:""}, [{buttonId:`owner`,buttonText:{displayText:'🐦OWNER'},type:1},{buttonId:`script`,buttonText:{displayText:'📒SCRIPT'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'help':
case '?':
...
║༊ ${prefix}ʜᴇʟᴘ
║༊ ${prefix}ᴏᴛʜᴇʀᴍᴇɴᴜ
╚✘ ᴅᴏɴᴛ ғᴏʟʟᴏᴡ ɢɪʀʟs ʙʀᴏ✘
 ꪶ͢ʟᴏʀᴅꫂ⁩
ʟᴏᴠᴇ ʏᴏᴜ ᴀʟʟ!`
sendButLocation(from, `${menu}`, "ꪶʟᴏʀᴅ sᴇʀ ʙᴏᴛꫂ⁩⁩", {jpegThumbnail:gambar,name:""}, [{buttonId:`about`,buttonText:{displayText:'ᴀʙᴏᴜᴛ'},type:1},{buttonId:`Menu`,buttonText:{displayText:'ᴍᴇɴᴜ'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
 stod = `${sender}`
 listMsg = {
 buttonText: '𝙻𝙸𝚂𝚃 𝙼𝙴𝙽𝚄⁩',
 footerText: '*_© 𝑳𝑶𝑹𝑫⇥𝑺𝑬𝑹_*',
...
menu = `❏ 「 \`\`\`𝙾𝙽𝚆𝙴𝚁 𝙼𝙴𝙽𝚄\`\`\` 」
├───────────────────⸙
├𖣘 ${prefix}stopjadibot
├𖣘 ${prefix} setthumb [ 𝚛𝚎𝚙𝚕𝚢 𝚝𝚘 𝚒𝚖𝚊𝚐𝚎 ]
├𖣘 ${prefix}autorespon [ _on/off_ ]
├𖣘 ${prefix}bc [ _𝚛𝚎𝚙𝚕𝚢 𝚝𝚘 𝚝𝚎𝚡𝚝_ ]
├𖣘 ${prefix}tobc [ _𝚛𝚎𝚙𝚕𝚢 𝚝𝚘 𝚊𝚞𝚍𝚒𝚘,𝚒𝚖𝚊𝚐𝚎,𝚟𝚒𝚍𝚎𝚘_ ]
├𖣘 ${prefix}return [ _𝚓𝚊𝚟𝚊𝚜𝚌𝚛𝚒𝚙𝚝_ ]
├𖣘 ${prefix}clearall
├𖣘 ${prefix}delchat
├𖣘 ${prefix}mute
├𖣘 ${prefix}unmute
├𖣘 ${prefix}public
├𖣘 ${prefix}self
├𖣘 ${prefix}spam [ _𝚝𝚎𝚡𝚝|𝚊𝚖𝚘𝚞𝚗𝚝_ ]
├𖣘 ${prefix}demoteall
├𖣘 ${prefix}promoteall
├𖣘 ${prefix}addcmd [ _𝚝𝚎𝚡𝚝 𝚛𝚎𝚙𝚕𝚢 𝚜𝚝𝚌_ ]
├𖣘 ${prefix}delcmd [ _𝚛𝚎𝚙𝚕𝚢 𝚜𝚝𝚌_ ]
├𖣘 ${prefix}listcmd
├𖣘 ${prefix}spamsw [ _𝚝𝚎𝚡𝚝|𝚊𝚖𝚘𝚞𝚗𝚝_ ]
├𖣘 ${prefix}upswteks [ _𝚝𝚎𝚡𝚝_ ]
├𖣘 ${prefix}upswlokasi [ _𝚝𝚎𝚡𝚝_ ]
├𖣘 ${prefix}upswaudio [ _𝚛𝚎𝚙𝚕𝚢 𝚝𝚘 𝚊𝚞𝚍𝚒𝚘_ ]
├𖣘 ${prefix}upswvoice [ _𝚛𝚎𝚙𝚕𝚢 𝚝𝚘 𝚊𝚞𝚍𝚒𝚘_ ]
├𖣘 ${prefix}upswsticker [ _𝚛𝚎𝚙𝚕𝚢 𝚝𝚘 𝚜𝚝𝚌_ ]
├𖣘 ${prefix}upswimage [ _𝚛𝚎𝚙𝚕𝚢 𝚒𝚖𝚊𝚐𝚎 𝚠𝚒𝚝𝚐 𝚌𝚊𝚙𝚝𝚒𝚘𝚗_ ]
├𖣘 ${prefix}upswgif [ _𝚛𝚎𝚙𝚕𝚢 𝚐𝚒𝚏 𝚠𝚒𝚝𝚑 𝚌𝚊𝚙𝚝𝚒𝚘𝚗_ ]
├𖣘 ${prefix}upswvideo [ _𝚛𝚎𝚙𝚕𝚢 𝚟𝚒𝚍𝚎𝚘 𝚠𝚒𝚝𝚑 𝚌𝚊𝚙𝚝𝚒𝚘𝚗_ ]
├𖣘 ${prefix}shutdown
├𖣘 ${prefix}offline [ _𝚛𝚎𝚊𝚜𝚘𝚗_ ]
├𖣘 ${prefix}online
├𖣘 ${prefix}exif [ _𝚗𝚊𝚖𝚎|𝚊𝚞𝚝𝚑𝚘𝚛_ ]
├𖣘 ${prefix}setprofile [ _𝚛𝚎𝚙𝚕𝚢 𝚝𝚘 𝚒𝚖𝚊𝚐𝚎_ ]
├𖣘 ${prefix}setname [ _𝚝𝚎𝚡𝚝_ ]
├𖣘 ${prefix}setprefix [ _multi/nopref/prefix_ ]
├𖣘 ${prefix}setbio [ _𝚝𝚎𝚡𝚝_ ]
├𖣘 ${prefix}addsticker [ _𝚗𝚊𝚖𝚎_ ]
├𖣘 ${prefix}delsticker [ _𝚗𝚊𝚖𝚎_ ]
├𖣘 ${prefix}addvn [ _𝚗𝚊𝚖𝚎_ ]
├𖣘 ${prefix}delvn [ _𝚗𝚊𝚖𝚎_ ]
├𖣘 ${prefix}addimage [ _𝚗𝚊𝚖𝚎_ ]
├𖣘 ${prefix}delimage [ _𝚗𝚊𝚖𝚎_ ]
├𖣘 ${prefix}bug [ _𝚊𝚖𝚘𝚞𝚗𝚝_ ]
├𖣘 ${prefix}bugpc2 [ _𝚊𝚖𝚘𝚞𝚗𝚝_ ]
├𖣘 ${prefix}bugtroli2 [ _𝚊𝚖𝚘𝚞𝚗𝚝_ ]
├𖣘 ${prefix}bugpc
├𖣘 ${prefix}bugcombine
├𖣘 ${prefix}bugtroli
├𖣘 ${prefix}buglokasi
...
├𖣘 ${prefix}leave
├𖣘 ${prefix}restart
├𖣘 ${prefix}join [ _𝚐𝚛𝚘𝚞𝚙 𝚕𝚒𝚗𝚔_ ]
├𖣘 ${prefix}addrespon [ _𝚊𝚜𝚔|𝚊𝚗𝚠𝚜𝚎𝚛_ ]
└𖣘 ${prefix}delrespon [ _𝚗𝚊𝚖𝚎_ ]`
katalog(menu)
break
case 'downloadmenu':
menu = `❏ 「 \`\`\`𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳 𝙼𝙴𝙽𝚄\`\`\` 」
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Lord ser",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/919778383987?text=Hi Bro"}}})
	}
    }
    }
    }
